...
public class Vehiculo {
    ...
    @Pattern(regexp = "^[A-Z]{3}-[0-9]{3,4}$", message = "Formato de placa inválido (Ejemplo: ABC-123)")
    ...
    public Vehiculo(String marca, String modelo, Integer anio, String color, 
                   String placa, Double precio, String tipoCombustible, 
                   String transmision, Integer kilometraje, String estado, String descripcion) {
        this.marca = marca;
        this.modelo = modelo;
        this.anio = anio;
        this.color = color;
